...
const MESSAGES: Record<AppLang, Record<AiContext, MessageSet>> = {
  ru: {
    mentor: {
      ...
      timeout: 'Сетевая ошибка или таймаут. Повторите позже. Если вы в РФ — включите VPN.',
      ...
      fallback: 'ИИ наставник временно недоступен. Проверьте подключение. Если вы в РФ — включите VPN и повторите через 10–20 секунд.',
    },
    knowledge: {
      ...
      fallback: 'Не удалось извлечь сущности. Проверьте сеть. Если вы в РФ — включите VPN и повторите попытку.',
    },
  },
  en: {
    mentor: {
