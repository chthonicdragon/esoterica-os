...
export const CATALOG: CatalogItem[] = [
  ...
  { id: 'tool_ouija_board', category: 'tools', label: 'Ouija Board', labelRu: 'Доска Уиджи', color: '#7f674f', emissive: '#8b6a4a', emissiveIntensity: 0.14, geometry: 'custom', modelUrl: '/models/ouija_board.glb', scale: [0.24, 0.24, 0.24], placementYOffset: -0.01, placementRotationX: Math.PI / 2, unlockLevel: 4, points: 22 },
  ...
  { id: 'decor_ritual_altar', category: 'decor', label: 'Ritual Cloth', labelRu: 'Ритуальная скатерть', color: '#635b56', emissive: '#4a3f39', emissiveIntensity: 0.1, geometry: 'custom', modelUrl: '/models/ritual_altar_base.glb', scale: [0.6, 0.6, 0.6], placementYOffset: 0.05, unlockLevel: 5, points: 18 },
  { id: 'decor_tarot_table', category: 'decor', label: 'Tarot Cloth', labelRu: 'Таро скатерть', color: '#6b5a49', emissive: '#4f3f30', emissiveIntensity: 0.1, geometry: 'custom', modelUrl: '/models/tarot_table_base.glb', scale: [0.6, 0.6, 0.6], placementYOffset: 0.04, unlockLevel: 3, points: 15 },
  ...
  { id: 'decor_sarmatian_skull', category: 'decor', label: 'Sarmatian Skull', labelRu: 'Сарматский череп', color: '#d7d1c8', emissive: '#9aa3b0', emissiveIntensity: 0.16, geometry: 'custom', modelUrl: '/models/sarmatian_skull.glb', scale: [0.2, 0.2, 0.2], unlockLevel: 4, points: 19 },
  ...
  { id: 'decor_triangle_artifact', category: 'decor', label: 'Triangulium', labelRu: 'Треугольный артефакт', color: '#6a6f88', emissive: '#7f8cff', emissiveIntensity: 0.26, geometry: 'custom', modelUrl: '/models/triangulium.glb', scale: [0.2, 0.2, 0.2], effect: 'glow', unlockLevel: 4, points: 17 },
  ...
  { id: 'statue_isis', category: 'statues', label: 'Isis', labelRu: 'Исида', color: '#a8926f', emissive: '#80684a', emissiveIntensity: 0.22, geometry: 'custom', modelUrl: '/models/isis_statue.glb', scale: [0.26, 0.26, 0.26], unlockLevel: 5, points: 27 },
  ...
  { id: 'tool_runes_grimoire', category: 'tools', label: 'Runes Grimoire', labelRu: 'Гримуар Рун', color: '#4d3a2a', emissive: '#6f4e37', emissiveIntensity: 0.18, geometry: 'custom', modelUrl: '/models/book_of_runes.glb', scale: [0.2, 0.2, 0.2], placementYOffset: -0.012, unlockLevel: 3, points: 18 },
  ...
  { id: 'tool_paladin_book', category: 'tools', label: 'Paladin’s Book', labelRu: 'Книга паладина', color: '#4d3a2a', emissive: '#6f4e37', emissiveIntensity: 0.18, geometry: 'custom', modelUrl: '/models/paladins_book.glb', scale: [0.2, 0.2, 0.2], placementYOffset: -0.012, unlockLevel: 3, points: 17 }
]
