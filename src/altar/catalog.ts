...
export const ALTAR_BASES: AltarBaseOption[] = [
  ...
  {
    id: 'base_occult_table',
    label: 'Occult Table',
    labelRu: 'Оккультный стол',
    modelUrl: '/models/occult_table_base.glb',
    unlockLevel: 5,
    preview: 'Occult',
    tint: '#5e4a3f',
    targetSpan: 2.05,
...
export const CATALOG: CatalogItem[] = [
  ...
  { id: 'statue_anubis_glb', category: 'statues', label: 'Anubis Statue', labelRu: 'Статуя Анубиса', color: '#2a1f1a', emissive: '#553311', emissiveIntensity: 0.22, geometry: 'custom', modelUrl: '/models/anubis_statue.glb', scale: [0.26, 0.26, 0.26], unlockLevel: 5, points: 28 },
  { id: 'statue_bastet_cat', category: 'statues', label: 'Bastet Cat', labelRu: 'Кошка Бастет', color: '#2b2422', emissive: '#664422', emissiveIntensity: 0.2, geometry: 'custom', modelUrl: '/models/bastet_cat.glb', scale: [0.22, 0.22, 0.22], unlockLevel: 4, points: 24 },
  { id: 'statue_horus_glb', category: 'statues', label: 'Horus Statue', labelRu: 'Статуя Хоруса', color: '#4d4338', emissive: '#8a6b3a', emissiveIntensity: 0.24, geometry: 'custom', modelUrl: '/models/horus_statue.glb', scale: [0.26, 0.26, 0.26], unlockLevel: 5, points: 27 },
  
  { id: 'decor_candelabra', category: 'decor', label: 'Candelabra', labelRu: 'Канделябр', color: '#b8a27a', emissive: '#ffb347', emissiveIntensity: 0.25, geometry: 'custom', modelUrl: '/models/candelabra.glb', scale: [0.22, 0.22, 0.22], effect: 'flicker', unlockLevel: 2, points: 16 },
  { id: 'candles_pack', category: 'candles', label: 'Candles Pack', labelRu: 'Набор свечей (GLB)', color: '#e5d5b8', emissive: '#ff9d4f', emissiveIntensity: 0.22, geometry: 'custom', modelUrl: '/models/candles_pack.glb', scale: [0.2, 0.2, 0.2], effect: 'flicker', unlockLevel: 2, points: 18 },
  
  { id: 'tool_grimoire', category: 'tools', label: 'Grimoire', labelRu: 'Гримуар', color: '#3e2f28', emissive: '#6a4b3b', emissiveIntensity: 0.2, geometry: 'custom', modelUrl: '/models/magic_book.glb', scale: [0.2, 0.2, 0.2], placementYOffset: -0.012, unlockLevel: 3, points: 19 },
  { id: 'tool_potion', category: 'tools', label: 'Potion Bottle', labelRu: 'Зелье', color: '#4a6a7f', emissive: '#77bbee', emissiveIntensity: 0.35, geometry: 'custom', modelUrl: '/models/potion.glb', scale: [0.16, 0.16, 0.16], effect: 'glow', unlockLevel: 2, points: 12 },
  { id: 'tool_mortar_pestle', category: 'tools', label: 'Mortar & Pestle', labelRu: 'Ступка и пестик', color: '#6b5f55', emissive: '#3a2f28', emissiveIntensity: 0.12, geometry: 'custom', modelUrl: '/models/mortar_pestle.glb', scale: [0.2, 0.2, 0.2], placementYOffset: 0.01, unlockLevel: 2, points: 14 },
  { id: 'tool_ouija_board', category: 'tools', label: 'Ouija Board', labelRu: 'Доска Уиджи', color: '#7f674f', emissive: '#8b6a4a', emissiveIntensity: 0.14, geometry: 'custom', modelUrl: '/models/ouija_board.glb', scale: [0.22, 0.22, 0.22], placementYOffset: -0.02, placementRotationX: Math.PI / 2, unlockLevel: 4, points: 22 },
  
  { id: 'decor_raven_skull', category: 'decor', label: 'Raven Skull', labelRu: 'Череп ворона', color: '#cfcfcf', emissive: '#8892a6', emissiveIntensity: 0.18, geometry: 'custom', modelUrl: '/models/raven_skull.glb', scale: [0.2, 0.2, 0.2], unlockLevel: 3, points: 17 },
  { id: 'decor_runic_stone', category: 'decor', label: 'Runic Stone', labelRu: 'Рунический камень', color: '#5f6a6f', emissive: '#445a88', emissiveIntensity: 0.22, geometry: 'custom', modelUrl: '/models/runic_stone.glb', scale: [0.24, 0.24, 0.24], unlockLevel: 3, points: 18 },
  { id: 'decor_witch_orb', category: 'decor', label: 'Witch Orb', labelRu: 'Ведьмин шар', color: '#6b5ad1', emissive: '#8a7bff', emissiveIntensity: 0.36, geometry: 'custom', modelUrl: '/models/witch_orb.glb', scale: [0.18, 0.18, 0.18], effect: 'glow', unlockLevel: 4, points: 20 },
  { id: 'decor_ritual_altar', category: 'decor', label: 'Ritual Cloth', labelRu: 'Ритуальная скатерть', color: '#635b56', emissive: '#4a3f39', emissiveIntensity: 0.1, geometry: 'custom', modelUrl: '/models/ritual_altar_base.glb', scale: [0.56, 0.56, 0.56], placementYOffset: 0.018, unlockLevel: 5, points: 18 },
  { id: 'decor_tarot_table', category: 'decor', label: 'Tarot Cloth', labelRu: 'Таро скатерть', color: '#6b5a49', emissive: '#4f3f30', emissiveIntensity: 0.1, geometry: 'custom', modelUrl: '/models/tarot_table_base.glb', scale: [0.56, 0.56, 0.56], placementYOffset: 0.016, unlockLevel: 3, points: 15 },
  { id: 'decor_wolf_skull', category: 'decor', label: 'Wolf Skull', labelRu: 'Череп волка', color: '#d9d9d9', emissive: '#a0a6b3', emissiveIntensity: 0.16, geometry: 'custom', modelUrl: '/models/wolf_skull.glb', scale: [0.18, 0.18, 0.18], unlockLevel: 3, points: 16 },
  { id: 'decor_steer_skull', category: 'decor', label: 'Steer Skull', labelRu: 'Череп быка', color: '#ddd7cf', emissive: '#9aa3b0', emissiveIntensity: 0.16, geometry: 'custom', modelUrl: '/models/low_poly_steer_skull.glb', scale: [0.22, 0.22, 0.22], unlockLevel: 4, points: 18 },
  { id: 'decor_sarmatian_skull', category: 'decor', label: 'Sarmatian Skull', labelRu: 'Сарматский череп', color: '#d7d1c8', emissive: '#9aa3b0', emissiveIntensity: 0.16, geometry: 'custom', modelUrl: '/models/sarmatian_skull.glb', scale: [0.18, 0.18, 0.18], placementYOffset: -0.008, unlockLevel: 4, points: 19 },
  { id: 'decor_ionic_column', category: 'decor', label: 'Ionic Column', labelRu: 'Ионическая колонна', color: '#b8b8bc', emissive: '#8c8ca0', emissiveIntensity: 0.1, geometry: 'custom', modelUrl: '/models/ionic_fantasy_column.glb', scale: [0.28, 0.28, 0.28], unlockLevel: 3, points: 14 },
  { id: 'decor_triangle_artifact', category: 'decor', label: 'Triangulium', labelRu: 'Треугольный артефакт', color: '#6a6f88', emissive: '#7f8cff', emissiveIntensity: 0.26, geometry: 'custom', modelUrl: '/models/triangulium.glb', scale: [0.18, 0.18, 0.18], placementYOffset: -0.01, effect: 'glow', unlockLevel: 4, points: 17 },
  { id: 'decor_idol', category: 'decor', label: 'Idol', labelRu: 'Идол', color: '#6f6458', emissive: '#4e3f2f', emissiveIntensity: 0.18, geometry: 'custom', modelUrl: '/models/idol.glb', scale: [0.22, 0.22, 0.22], unlockLevel: 3, points: 16 },
  { id: 'decor_idol_guardian', category: 'decor', label: 'Idol Guardian', labelRu: 'Идол-страж', color: '#6f6458', emissive: '#4e3f2f', emissiveIntensity: 0.18, geometry: 'custom', modelUrl: '/models/idol_guardian.glb', scale: [0.22, 0.22, 0.22], unlockLevel: 4, points: 18 },
  { id: 'statue_isis', category: 'statues', label: 'Isis', labelRu: 'Исида', color: '#a8926f', emissive: '#80684a', emissiveIntensity: 0.22, geometry: 'custom', modelUrl: '/models/isis_statue.glb', scale: [0.24, 0.24, 0.24], placementYOffset: -0.012, unlockLevel: 5, points: 27 },
  { id: 'tool_occult_books', category: 'tools', label: 'Occult Books', labelRu: 'Оккультные книги', color: '#4d3a2a', emissive: '#6f4e37', emissiveIntensity: 0.18, geometry: 'custom', modelUrl: '/models/occult_books.glb', scale: [0.22, 0.22, 0.22], placementYOffset: -0.012, unlockLevel: 2, points: 14 },
  { id: 'tool_runes_grimoire', category: 'tools', label: 'Runes Grimoire', labelRu: 'Гримуар Рун', color: '#4d3a2a', emissive: '#6f4e37', emissiveIntensity: 0.18, geometry: 'custom', modelUrl: '/models/book_of_runes.glb', scale: [0.18, 0.18, 0.18], placementYOffset: -0.02, unlockLevel: 3, points: 18 },
  { id: 'tool_witch_book', category: 'tools', label: 'Witch’s Book', labelRu: 'Книга ведьмы', color: '#4d3a2a', emissive: '#6f4e37', emissiveIntensity: 0.18, geometry: 'custom', modelUrl: '/models/witchs_book.glb', scale: [0.2, 0.2, 0.2], placementYOffset: -0.012, unlockLevel: 2, points: 15 },
  { id: 'tool_paladin_book', category: 'tools', label: 'Paladin’s Book', labelRu: 'Книга паладина', color: '#4d3a2a', emissive: '#6f4e37', emissiveIntensity: 0.18, geometry: 'custom', modelUrl: '/models/paladins_book.glb', scale: [0.18, 0.18, 0.18], placementYOffset: -0.02, unlockLevel: 3, points: 17 }
]
