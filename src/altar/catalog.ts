...
export const CATALOG: CatalogItem[] = [
  ...
  // Model placeholders: external GLB assets were missing in production and caused scene crashes.
  { id: 'model_candles_set', category: 'models', label: 'Candles Set', labelRu: 'Набор свечей', color: '#d7c8a8', emissive: '#ff9b3d', emissiveIntensity: 0.2, geometry: 'cylinder', scale: [0.1, 0.28, 0.1], effect: 'flicker', unlockLevel: 1, points: 14 },
  { id: 'model_artemis', category: 'models', label: 'Artemis', labelRu: 'Артемида', color: '#c8c9d2', emissive: '#7e89d6', emissiveIntensity: 0.25, geometry: 'cylinder', scale: [0.12, 0.42, 0.12], unlockLevel: 1, points: 20 },
  { id: 'model_candle_holder', category: 'models', label: 'Candle Holder', labelRu: 'Подсвечник', color: '#c8b08b', emissive: '#ff9d4f', emissiveIntensity: 0.2, geometry: 'cone', scale: [0.1, 0.2, 0.1], effect: 'flicker', unlockLevel: 1, points: 16 },
  { id: 'model_venus', category: 'models', label: 'Venus Goddess', labelRu: 'Богиня Венера', color: '#d5c8b8', emissive: '#9c8ad6', emissiveIntensity: 0.25, geometry: 'cylinder', scale: [0.12, 0.4, 0.12], unlockLevel: 1, points: 22 },
]
