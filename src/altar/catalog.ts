...
export const CATALOG: CatalogItem[] = [
  ...
  { id: 'statue_falcon_guardian', category: 'statues', label: 'Falcon Guardian', labelRu: 'Соколиный страж', color: '#a8926f', emissive: '#80684a', emissiveIntensity: 0.24, geometry: 'custom', modelUrl: '/models/egyptian_falcon_guardian.glb', scale: [0.24, 0.24, 0.24], unlockLevel: 4, points: 25 },
  ...
  { id: 'herb_colorful_sage', category: 'herbs', label: 'Colorful Sage', labelRu: 'Разноцветный шалфей', color: '#72a37e', emissive: '#3e7a56', emissiveIntensity: 0.12, geometry: 'custom', modelUrl: '/models/colorful_sage.glb', scale: [0.2, 0.2, 0.2], unlockLevel: 2, points: 11 },
  { id: 'herb_dried_sagebrush', category: 'herbs', label: 'Dried Sagebrush', labelRu: 'Сушёный шалфей', color: '#6f8a62', emissive: '#38503a', emissiveIntensity: 0.12, geometry: 'custom', modelUrl: '/models/dried_sagebrush.glb', scale: [0.2, 0.2, 0.2], unlockLevel: 2, points: 12 },
  { id: 'herb_dried_lavender', category: 'herbs', label: 'Dried Lavender Flowers', labelRu: 'Сушёная лаванда', color: '#8d78c7', emissive: '#5f4a8a', emissiveIntensity: 0.16, geometry: 'custom', modelUrl: '/models/dried_lavender_flowers.glb', scale: [0.22, 0.22, 0.22], unlockLevel: 3, points: 15 },
